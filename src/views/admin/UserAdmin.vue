  ...
  <div>
    ...
    <Table
        ...
        <template #op="{ index, row}">
          <div class="group-btn">
            <el-button type="primary" size="small" @click="showSendMsg">发送消息</el-button>
            <el-button v-if="row.status == 1" type="danger" size="small" @click="showSendMsg(1)">禁用</el-button>
            <el-button v-if="row.status == 0" type="primary" size="small">启用</el-button>
          </div>
        </template>
    </Table>
    <el-dialog
