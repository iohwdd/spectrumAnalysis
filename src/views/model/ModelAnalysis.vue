<template>
  ...
  <el-button type="primary" @click="toModelAnalysis2()"  style="margin-left: 600px;margin-top: 50px; width: 160px; height: 50px;">开始建模分析</el-button>
...
<div class="header">
    请选择模型：
    <el-cascader :options="options"  v-model="selectedValue" @change="handleChange" />
<!--
    结果选择：
  ...
  <div class="demo-drawer__content">
    <div class="left-left-demo">
      <div class="left-left-demo-header">
        <p style="margin: 0;font-weight: 700;"><el-icon><Star /></el-icon>1 &nbsp;&nbsp;树</p>
      </div>
    ...
    <div class="left-left-demo">
      <div class="left-left-demo-header">
        <p style="margin: 0;font-weight: 700;"><el-icon><Star /></el-icon>2 &nbsp;&nbsp;线性回归</p>
      </div>
    ...
    <div class="left-left-demo">
      <div class="left-left-demo-header">
        <p style="margin: 0;font-weight: 700;"><el-icon><Star /></el-icon>3 &nbsp;&nbsp;神经网络</p>
      </div>
...
<div class="main">
  ...
  <el-form-item style="margin-top: 50px;margin-left: 550px;">
    <el-button type="primary" @click="onSubmit();toModelAnalysis3()">确定</el-button>
  </el-form-item>
</el-form>
</div>
  ...
  <div class="header-3">
    ...
    :options="options2"
     />
      ...
      <el-button type="primary" @click="toModelAnalysis3_2()" style="margin-left: 950px;width: 100px;margin-top: 20px;">新建模型</el-button>
  ...
  <div id="chart" :class="{hidden1:isHidden3_1}"  style="width: 800px; height: 500px; margin-left: 150px;margin-top: 100px;position: absolute;">
  </div>

  <div id="chart2" :class="{hidden2:isHidden3_2}"  style="width: 800px; height: 500px; margin-left: 150px;margin-top: 100px;position: absolute;">
  </div>
