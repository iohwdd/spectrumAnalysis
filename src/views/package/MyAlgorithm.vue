<template>
  <div>
        ...
        <el-row>
          ...
          <el-col :span="6" :style="{ 'padding-left': '10px' }">
            <el-button-group>
              ...
              <el-button type="primary" @click="downloadBatch" :disabled="false"
                >批量下载</el-button
              >
              <el-button type="danger" @click="delBatch" :disabled="false"
                >批量删除</el-button
              >
            </el-button-group>
          </el-col>
          <el-col :span="4">
            <el-button type="primary" @click="uploadVisable = true"
              >上传算法</el-button
            >
            <el-dialog
                ...
                >
                  <el-form-item label="算法名称" prop="algoName">
                    <el-input
                      clearable
                      placeholder="提示信息"
                      v-model.trim="formData.algoName"
                    ></el-input>
                  </el-form-item>
    ...
    <el-dialog v-model="applyVisiable" title="上传算法" width="500">
      <div class="apply-panel">
        <el-input
          ...
          v-model.trim="formData.algoDesc"
        ></el-input>
        <el-button type="primary" class="apply-button"> 申请 </el-button>
      </div>
    </el-dialog>
  </div>
</template>
